                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('admin/cab_category')}}">Cab Category</a>
                                    <a class="nav-link" href="{{url('admin/cab_list')}}">Cab List</a>
                                    <a class="nav-link" href="{{url('admin/cab_price')}}">Cab Price</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="{{url('admin/driver_list')}}">Driver List</a>
                            ...
                            <div class="collapse" id="collapsePage" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    <a class="nav-link" href="{{url('admin/city_list')}}">Operated Cities</a>
                ...
                <!-- <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Date: <?php echo date('d-m-y')?></div>
                        </div>
                    </div>
                </footer> -->
            </div>
